# DISCLAIMER: THIS WAS THE FIRST DRAFT, FILE WAS ADDED SO BITLY LINK STILL WORKED
# REFER TO "https://github.com/choucurtis987/custom_projects/blob/master/kmeans_stuff/trying_kmeans.py"
# FINAL VERSION OF THE CUSTOM KMEANS ALGORITHM IS PROVIDED IN THE LINK
...
class scrap_kmeans:
    ...
    # takes numpy array or list of lists as argument:
    def fit(self,data):
        centroids = set()
        ...
        # starting centroids:
        first_centroids = [np.array(centroid) for centroid in centroids]
        ...
        self.centroids = storage[-1]

        # process of changing centroids
